...
public class StudentService {
    ...
    public Student updateStudent(Student request) {
        Student student = studentRepository.findById(request.getId())
                .orElseThrow(() -> new RuntimeException("Student not found with id " + request.getId()));
    ...
    public ResultPagination getAllStudent(Specification<Student> spec, Pageable pageable) {

...
public class HoaDonService {
    ...
    public HoaDonService(HoadonRepository hoadonRepository, SoDienNuocRepository soDienNuocRepository,
            EmailService emailService, RoomService roomService) {
    ...
    public Hoadon create(Long soDienNuocId) {
        ...
        if (soDn != null) {
            ...
            hoadon.setTienPhong(room.getPrice());
            hoadon.setTienRac(30000);
            hoadon.setTongTien(
    ...
    public void sendHoaDon(long id) {
        ...
        String subject = "Hoá đơn điện-nước tháng " + month + " năm "
                + hoadon.getCreateAt().atZone(ZoneId.systemDefault()).getYear();
